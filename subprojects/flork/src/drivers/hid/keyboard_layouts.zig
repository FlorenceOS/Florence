...
fn sv_SE_QWERTY(state: *const keyboard.KeyboardState, key: Location) !Input {
    ...
    switch (key) {
        .LeftOf1 => {
            if (alt) return Input.ParagraphSign;
            return Input.SectionSign;
        },
        .NumberKey1 => {
            if (shift) return Input.ExclamationMark;
            return Input.@"1";
        },
        .NumberKey2 => {
        ...
        .Line1_11 => {
            if (alt) return Input.Umlaut;
            return Input.AWithRing;
        },
        .Line1_12 => {
        ...
        .Line2_10 => {
            if (alt) return Input.SlashedO;
            return Input.OWithUmlaut;
        },
        .Line2_11 => {
            if (alt) return Input.Ash;
            return Input.AWithUmlaut;
        },
        .Line2_12 => {
        ...
        .Line3_8 => {
            if (shift) return Input.Semicolon;
            return Input.Comma;
        },
        .Line3_9 => {
            if (shift) return Input.Colon;
            return Input.Period;
        },
        .Line3_10 => {
            if (shift) return Input.Underscore;
            return Input.Minus;
        },
...
fn en_US_QWERTY(state: *const keyboard.KeyboardState, key: Location) !Input {
    ...
    switch (key) {
        .LeftOf1 => {
            if (shift) return Input.Tilde;
            return Input.Backtick;
        },
        .NumberKey1 => {
            if (shift) return Input.ExclamationMark;
            return Input.@"1";
        ...
        .NumberKey4 => {
            if (shift) return Input.DollarCurrency;
            return Input.@"4";
        },
        .NumberKey5 => {
            if (shift) return Input.Percent;
        ...
        .LeftOfBackspace => {
            if (shift) return Input.Plus;
            return Input.Equals;
        },

        .Line1_11 => {
            if (shift) return Input.OpenCurlyBrace;
            return Input.OpenSqBracket;
        },
        .Line1_12 => {
            if (shift) return Input.CloseCurlyBrace;
            return Input.CloseSqBracket;
        },
        .Line1_13 => {
            if (shift) return Input.VerticalBar;
        ...
        .Line2_11 => {
            if (shift) return Input.Apostrophe;
            return Input.QuotationMark;
        },

        .Line3_8 => {
            if (shift) return Input.LessThan;
            return Input.Comma;
        },
        .Line3_9 => {
            if (shift) return Input.GreaterThan;
